...
1. Что такое middleware Laravel?

2. Укажите разницу между методом get и post.

3. Что такое контракты laravel?

4. Что такое Composer?

5.  Что означает ORM?

6. доступные типы отношений в Laravel Eloquent.
